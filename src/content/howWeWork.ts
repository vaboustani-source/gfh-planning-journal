...
export const HOW_WE_WORK_SECTIONS: Section[] = [
  ...
  },
  {
    ...
    keyPoints: [
      "The director of your weekend: your timeline, your day, every fire put out.",
      "Three planning calls: post-booking, 90 days, 30 days.",
      "No full planner? We coordinate your rehearsal and wedding day. Have one? We support them.",
    ],
    facts: ["3 calls included", "$100/hr extra calls", "$50/revision"],
    blocks: [
      { type: "p", text: "Your Weekend Event Coordinator makes sure your weekend is carried out exactly as you envisioned it. They are the person who knows where everything is, when everything happens, and who is responsible for it. " },
      { type: "p", lead: "Without a full planner,", text: "your coordinator coordinates your ceremony rehearsal and your wedding day, and is the point person and manager on duty for your vendors on the day, so their questions go to us instead of to you and your families." },
      { type: "p", lead: "With a full planner,", text: "your planner leads your vendors, and your coordinator's role is to support that planner in carrying out your vision." },
      ...
      { type: "ul", items: [
        ...
        { text: "Each vendor's arrival, load-in, and day-of responsibilities, built into your timeline" },
        { text: "Arrival times confirmed with every vendor 48 hours before your wedding (without a full planner)" },
        { text: "Day-of direction on site: without a full planner, your coordinator is the manager on duty for every vendor" },
        { text: "Coordination of estate spaces: ceremony sites, reception spaces, the grounds" },
        { text: "Your ceremony rehearsal, organized and directed. With a full planner, we support theirs." },
      ...
      { type: "ul", items: [
        ...
        { lead: "We coordinate vendors; we don't plan with them.", text: "Our role with your vendors is their day-of responsibilities only. We don't schedule calls with vendors, check their availability, or review their contracts, and we are never responsible for any vendor fulfilling their contract." },
  ...
  },
  {
    ...
    blocks: [
      { type: "p", text: "Your Weekend Event Coordinator is not a full-service wedding planner. They make sure the wedding you plan is carried out perfectly. A full planner helps you decide what that wedding is." },
      { type: "p", lead: "Without a full planner,", text: "we coordinate your ceremony rehearsal and your wedding day, and direct your vendors on the day. Many of our couples plan this way." },
      { type: "p", lead: "With a full planner,", text: "your planner leads, and your coordinator supports that planner in executing your vision." },
      { type: "table", columns: ["Task", "Gilbertsville Farmhouse", "A full planner"], rows: [
        ...
        ["Vendors", "Day-of coordination only: arrival times confirmed 48 hours out, load-in, and direction on site (without a full planner)", "Sources and books them, schedules calls, checks availability, reviews contracts"],
        ["Vendor contracts", "Never reviewed, and never our responsibility to enforce", "Reviewed and managed"],
        ["Vendor recommendations", "Honest feedback on who we've worked with", "Full sourcing and booking"],
        ["Rehearsal", "Coordinated and directed without a full planner. Supported by us with one.", "Leads it"],
        ["Wedding day", "Coordinated without a full planner: ceremony, introductions, dances, photos. Supported by us with one.", "Leads it"],
  ...
  },
  {
    ...
    keyPoints: [
      ...
      "No full planner? Your coordinator directs them on the day. Coordination only, never planning.",
    ],
    ...
    blocks: [
      ...
      { type: "ul", items: [
        ...
        { lead: "The relationship is yours.", text: "We don't broker introductions or negotiate vendor contracts. You hire your vendors directly, your agreements are with them, and their work is their own: Gilbertsville Farmhouse is never responsible for any vendor fulfilling their contract." },
        { lead: "Without a full planner, we're their point of contact on the day.", text: "Your Weekend Event Coordinator confirms each vendor's arrival time 48 hours before and directs their day-of responsibilities on site, so their questions come to us instead of to you. With a full planner, your planner is their contact." },
        { lead: "Coordination, not planning.", text: "We don't schedule calls with your vendors, check their availability, or review their contracts. That belongs to you or your planner." },
      ] },
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "table", columns: ["What it's about", "Who to ask"], pillColumn: 1, rows: [
        ...
        ["Vendor calls and availability", "Your Planner"],
  ...
  },
  {
    ...
    keyPoints: [
      "Twenty-two quick answers, each with the person who owns it.",
    ],
    facts: ["22 questions"],
    draft: true,
    blocks: [
      ...
      { type: "table", columns: ["Question", "Answer", "Owner"], pillColumn: 2, rows: [
        ...
        ["Do we need a full wedding planner?", "Not necessarily. Without one, your coordinator coordinates your ceremony rehearsal and wedding day, but doesn't design it or source vendors. See Us & Your Planner.", "Weekend Coordinator"],
        ["Can you get on a call with our florist, or check if a vendor is free?", "No. We coordinate vendors' day-of responsibilities only. Calls, availability, and contracts belong to you or your planner.", "Your Planner"],
