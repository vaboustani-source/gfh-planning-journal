...
import {
  ...
  MessageCircle, StickyNote, Briefcase, LogOut, Menu, X, Sparkles, User, FileText, Clock, ClipboardList, Armchair, MailCheck, Shield, ShieldCheck, Wallet, History as HistoryIcon, Compass, BookOpen
} from "lucide-react";
...
const allNavItems: NavItemDef[] = [
  ...
  { to: "/portal/how-we-work",     label: "How We Work",       icon: BookOpen,          tiers: [1, 3, 4],     tab: "overview" },
